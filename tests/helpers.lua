...
-- @usage global_equality(child, "_G.FlipperLoaded", true)
...
-- @usage global_type_equality(child, "_G.FlipperLoaded", "boolean")
...
Helpers.expect.config_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Flipper.config." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.state_equality = MiniTest.new_expectation(
    "state matches",
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Flipper.enabled." .. field, value)
    end,
    errorMessage
)
