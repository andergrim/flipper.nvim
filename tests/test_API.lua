...
T["setup()"]["sets exposed methods and default options value"] = function()
    child.lua([[require('flipper').setup()]])

    -- global object that holds your plugin information
    eq_type_global(child, "_G.Flipper", "table")

    -- public methods
    eq_type_global(child, "_G.Flipper.toggle", "function")
    eq_type_global(child, "_G.Flipper.disable", "function")
    eq_type_global(child, "_G.Flipper.enable", "function")

    -- config
    eq_type_global(child, "_G.Flipper.config", "table")
